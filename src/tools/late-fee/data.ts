...
export const LATE_FEE: Record<string, LateFeeRule> = {
  ...
  CO: {
    ...
    cite: { statute: "Colo. Rev. Stat. § 38-12-105", lastVerified: "2026-06-12", confidence: "high" },
  },
  CT: {
    graceDays: 9,
    capType: "percent_or_flat",
    ...
    capFlat: 50,
    combine: "lesser",
    notes: "Connecticut caps the late fee at the lesser of $50 or 5% of the delinquent rent (the $5/day rule also tops out at $50), after a 9-day grace period (4 days for week-to-week). Only one late charge per payment.",
    cite: { statute: "Conn. Gen. Stat. § 47a-15a", lastVerified: "2026-06-12", confidence: "high" },
  },
  DE: {
    graceDays: 5,
    capType: "percent",
    ...
    cite: { statute: "25 Del. C. § 5501(d)", lastVerified: "2026-06-12", confidence: "high" },
  },
  ...
  HI: { graceDays: 0, capType: "percent", capPercent: 8, notes: "Hawaii caps late fees at 8% of the rent due; no statutory grace period.", cite: { statute: "Haw. Rev. Stat. § 521-21(f)", lastVerified: "2026-06-12", confidence: "high" } },
  ...
  MD: { graceDays: 0, capType: "percent", capPercent: 5, notes: "Maryland caps late fees at 5% of the rent due. A 2025 law (HB 273, eff. Oct 1, 2025) adds grace periods that vary by county (e.g. 10 days in Montgomery, 5 days in Prince George's) — check your county.", cite: { statute: "Md. Code, Real Prop. § 8-208(d)(3)", lastVerified: "2026-06-12", confidence: "high" } },
  MA: {
    graceDays: 30,
    capType: "reasonable",
    notes: "Massachusetts prohibits charging a late fee until the rent is 30 days late.",
    cite: { statute: "Mass. Gen. Laws ch. 186, § 15B(1)(c)", lastVerified: "2026-06-12", confidence: "high" },
  },
  MI: reasonable("Mich. Comp. Laws § 554", "low"),
  MN: reasonable("Minn. Stat. § 504B.177", "high", {
    capType: "percent",
    capPercent: 8,
  ...
  NV: {
    ...
    capType: "percent",
    capPercent: 5,
    notes: "Nevada caps late fees at 5% of the periodic rent, and no fee may be charged until at least 3 days after rent is due (for tenancies longer than week-to-week).",
    cite: { statute: "Nev. Rev. Stat. § 118A.210", lastVerified: "2026-06-12", confidence: "high" },
  },
  ...
  NM: { graceDays: 0, capType: "percent", capPercent: 10, notes: "New Mexico caps late fees at 10% of the rent for the period.", cite: { statute: "N.M. Stat. § 47-8-15(D)", lastVerified: "2026-06-12", confidence: "high" } },
  NY: {
    graceDays: 5,
    capType: "percent_or_flat",
    capPercent: 5,
  ...
  NC: {
    ...
    cite: { statute: "N.C. Gen. Stat. § 42-46", lastVerified: "2026-06-12", confidence: "high" },
  },
  ...
  OR: {
    ...
    cite: { statute: "Or. Rev. Stat. § 90.260", lastVerified: "2026-06-12", confidence: "high" },
  },
  ...
  TN: {
    ...
    cite: { statute: "Tenn. Code § 66-28-201(d)", lastVerified: "2026-06-12", confidence: "high" },
  },
  TX: {
    graceDays: 2,
    capType: "reasonable",
    ...
    cite: { statute: "Tex. Prop. Code § 92.019", lastVerified: "2026-06-12", confidence: "high" },
  },
  UT: reasonable("Utah Code § 57-22", "low"),
  VT: reasonable("9 V.S.A. § 4455", "low"),
  VA: reasonable("Va. Code § 55.1-1204", "high", {
    notes: "Virginia caps late fees at the lesser of 10% of the periodic rent or 10% of the remaining balance owed; rent is late if unpaid by the 5th.",
    capType: "percent",
    capPercent: 10,
  }),
